<?php
	...
	echo $this->Html->css('validationEngine.jquery','stylesheet',array('inline'=>false));
...
<div class="span-24">
	<p>You may use this form to contact us, or you may email the project team directly at: <strong>mappingmilitants@lists.stanford.edu</strong>. Please note that your comment will not appear on the feedback page until it has been approved by an administrator.</p>
